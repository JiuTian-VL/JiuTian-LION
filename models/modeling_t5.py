...
# Noted by LION Authors:
# IMPORTANT: This file is a modified version of the original T5 implementation from Hugging Face.
# Only the forward method of the T5ForConditionalGeneration class has been modified.
# This modification allows the model to support a specified reduction when calculating losses to implement a certain evaluation method
